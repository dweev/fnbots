...
import { saveFile, thuglife } from '../../function/index.js';

export const command = {
  name: 'thuglife',
  category: 'image',
  description: 'Add thuglife effect to an image',
  ...
  execute: async ({ fn, m, toId, dbSettings, quotedMsg, mentionedJidList, sReply }) => {
    ...
    if (m.message?.imageMessage) {
      ...
      return await sReply(`Mohon balas atau kirim gambar untuk di-thuglife.`);
    }
