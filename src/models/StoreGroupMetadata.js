...
groupMetadataSchema.methods.syncWithBaileys = function (baileysData) {
  Object.keys(baileysData).forEach(key => {
...
groupMetadataSchema.statics.fromBaileys = async function (baileysData) {
  ...
  return await group.syncWithBaileys(baileysData);
};
groupMetadataSchema.statics.bulkUpsert = async function (groupsArray) {
