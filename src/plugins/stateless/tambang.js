...
const layers = [
  {
    name: 'Permukaan Tanah',
    depth: 50,
    collapseChance: 0.15,
    opCostMultiplier: 0.05,
    rewards: [
    ...
    try {
      ...
      if (bi0 === 'all' || bi0 === 'allin') {
        ...
        if (sanitized.includes('.')) {
          ...
          bid = BigInt(sanitized) * multiplier;
        }
      }
      ...
      await delay(500);
      fn.sendReply(toId, finalMessage, { edit: key });
      await user.addXp();
    } finally {
