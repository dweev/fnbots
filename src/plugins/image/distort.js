...
import { saveFile, deepfry } from '../../function/index.js';

export const command = {
  name: 'distort',
  category: 'image',
  description: 'Distort an image using deepfry effect',
  ...
  execute: async ({ fn, m, toId, dbSettings, quotedMsg, mentionedJidList, sReply }) => {
    ...
    if (m.message?.imageMessage) {
      ...
      return await sReply(`Mohon balas atau kirim gambar untuk di-distort.`);
    }
