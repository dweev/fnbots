...
export const command = {
  ...
  execute: async ({ quotedMsg, sendRawWebpAsSticker, arg, sReply, dbSettings }) => {
    ...
    const colors = ['#26c4dc', '#792138', '#8b6990', '#f0b330', '#ae8774', '#5696ff', '#ff7b6b', '#57c9ff', '#243640', '#b6b327', '#c69fcc', '#54c265', '#6e257e', '#c1a03f', '#90a841', '#7acba5', '#8294ca', '#a62c71', '#ff8a8c', '#7e90a3', '#74676a'];
