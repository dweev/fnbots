...
import { saveFile, mirror } from '../../function/index.js';

export const command = {
  name: 'mirror',
  category: 'image',
  description: 'Add mirror effect to an image',
  ...
  execute: async ({ fn, m, toId, dbSettings, quotedMsg, mentionedJidList, sReply }) => {
    ...
    if (m.message?.imageMessage) {
      ...
      return await sReply(`Mohon balas atau kirim gambar untuk di-mirror.`);
    }
