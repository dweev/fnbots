...
import { saveFile, rejected } from '../../function/index.js';

export const command = {
  name: 'rejected',
  category: 'image',
  description: 'Add rejected effect to an image',
  ...
  execute: async ({ fn, m, toId, dbSettings, quotedMsg, mentionedJidList, sReply }) => {
    ...
    if (m.message?.imageMessage) {
      ...
      return await sReply(`Mohon balas atau kirim gambar untuk di-reject.`);
    }
