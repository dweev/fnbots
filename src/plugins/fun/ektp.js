...
export const command = {
  ...
  execute: async ({ fn, m, toId, quotedMsg, dbSettings, arg, sReply }) => {
    ...
    const dataOrder = ['NIK', 'Nama', 'Tempat/Tgl Lahir', 'Jenis Kelamin', 'Gol. Darah', 'Alamat', 'RT/RW', 'Kel/Desa', 'Kecamatan', 'Agama', 'Status Perkawinan', 'Pekerjaan', 'Kewarganegaraan', 'Berlaku Hingga'];
