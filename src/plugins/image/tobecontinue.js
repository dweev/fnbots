...
import { saveFile, tobecontinue } from '../../function/index.js';

export const command = {
  name: 'tobecontinue',
  category: 'image',
  description: 'Add to be continue effect to an image',
  ...
  execute: async ({ fn, m, toId, dbSettings, quotedMsg, mentionedJidList, sReply }) => {
    ...
    if (m.message?.imageMessage) {
      ...
      return await sReply(`Mohon balas atau kirim gambar untuk di-tobecontinue.`);
    }
